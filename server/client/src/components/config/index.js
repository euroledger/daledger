...
const Translations = () => {
    ...
    return {
        ...
        aboutustitle: t('footer.aboutus.title'),
        aboutustext: t('footer.aboutus.text', { returnObjects: true }),
        technologytitle: t('footer.technology.title'),
        technologytext: t('footer.technology.text', { returnObjects: true }),
        privacytitle: t('footer.privacy.title'),
        privacytext: t('footer.privacy.text', { returnObjects: true }),
        termstitle: t('footer.terms.title'),
        termstext: t('footer.terms.text', { returnObjects: true }),
